...
class ModelTrainer:
    def __init__(self,data_transofrmation_artifact:DataTransformationArtifact,
                 model_trainer_config:ModelTrainerConfig):
        self.data_transformation_artifact=data_transofrmation_artifact
        self.model_trainer_config=model_trainer_config

    
    def get_model_object_and_report(self,train:np.array,test:np.array)->Tuple[object,object]:
        try:
            logging.info('Using neuromf to get best model object and report')
            ...
            y=y_train,base_accuracy=self.model_trainer_config.expected_accuracy)
